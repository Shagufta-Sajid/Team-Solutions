                ...
                <div class="container bg-light text-dark my-4 py-3">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="inputs[0][level_of_education]" id="level_of_education" placeholder="Level of Education" class="@error('level_of_education') is-invalid @enderror">
                            @error('level_of_education')<strong class="text-danger">{{ $message }}</strong>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for = "degree_title">Degree Title</label>
                            <input type="text" name="inputs[0][degree_title]" id="degree_title" placeholder="Degree Title" class="@error('degree_title') is-invalid @enderror">
                            @error('degree_title')<strong class="text-danger">{{ $message }}</strong>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for = "group">Group</label>
                            <input type="text" name="inputs[0][group]" id="group" placeholder="Group" class="@error('group') is-invalid @enderror">
                            @error('group')<strong class="text-danger">{{ $message }}</strong>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for = "institution_name">Institution Name</label>
                            <input type="text" name="inputs[0][institution_name]" id="institution_name" placeholder="Institution Name" class="@error('institution_name') is-invalid @enderror">
                            @error('institution_name')<strong class="text-danger">{{ $message }}</strong>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for = "result">Result</label>
                            <input type="text" name="inputs[0][result]" id="result" placeholder="Result" class="@error('result') is-invalid @enderror">
                            @error('result')<strong class="text-danger">{{ $message }}</strong>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for = "scale">Scale</label>
                            <input type="decimal" name="inputs[0][scale]" id="scale" placeholder="Scale" class="@error('scale') is-invalid @enderror">
                            @error('scale')<strong class="text-danger">{{ $message }}</strong>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for = "cgpa">CGPA</label>
                            <input type="decimal" name="inputs[0][cgpa]" id="cgpa" placeholder="CGPA" class="@error('cgpa') is-invalid @enderror">
                            @error('cgpa')<strong class="text-danger">{{ $message }}</strong>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for = "batch">Batch</label>
                            <input type="integer" name="inputs[0][batch]" id="batch" placeholder="Batch" class="@error('batch') is-invalid @enderror">
                            @error('batch')<strong class="text-danger">{{ $message }}</strong>@enderror
                        </div>
                        <div class="col-md-4">
                            <label for = "passing_year">Passing Year</label>
                            <input type="integer" name="inputs[0][passing_year]" id="passing_year" placeholder="Passing Year" class="@error('passing_year') is-invalid @enderror">
...
<script>
    ...
    $('#add').click(function(){
        ...
        $('#table').append(
            `<div class="row">
            <div class="col-md-4">              
                <input type="text" name="inputs[`+i+`][level_of_education]" id="level_of_education" placeholder="Level of Education" class="@error('level_of_education') is-invalid @enderror">
                @error('level_of_education')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div class="col-md-4">
                <input type="text" name="inputs[`+i+`][degree_title]" id="degree_title" placeholder="Degree Title" class="@error('degree_title') is-invalid @enderror">
                @error('degree_title')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div class="col-md-4">                  
                <input type="text" name="inputs[`+i+`][group]" id="group" placeholder="Group" class="@error('group') is-invalid @enderror">
                @error('group')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div class="col-md-4">
                <input type="text" name="inputs[`+i+`][institution_name]" id="institution_name" placeholder="Institution Name" class="@error('institution_name') is-invalid @enderror">
                @error('institution_name')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div class="col-md-4">
                <input type="text" name="inputs[`+i+`][result]" id="result" placeholder="Result" class="@error('result') is-invalid @enderror">
                @error('result')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div class="col-md-4">
                <input type="decimal" name="inputs[`+i+`][scale]" id="scale" placeholder="Scale" class="@error('scale') is-invalid @enderror">
                @error('scale')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div class="col-md-4">
                <input type="decimal" name="inputs[`+i+`][cgpa]" id="cgpa" placeholder="CGPA" class="@error('cgpa') is-invalid @enderror">
                @error('cgpa')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div class="col-md-4">
                <input type="integer" name="inputs[`+i+`][batch]" id="batch" placeholder="Batch" class="@error('batch') is-invalid @enderror">
                @error('batch')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div class="col-md-4">
                <input type="integer" name="inputs[`+i+`][passing_year]" id="passing_year" placeholder="Passing Year" class="@error('passing_year') is-invalid @enderror">
                @error('passing_year')<strong class="text-danger">{{ $message }}</strong>@enderror
            </div>
            <div>
                <button type = "button" name = "remove" id = "remove" class="btn btn-danger remove-table-row">Remove</button>
                </div>
            </div>`);
    });
