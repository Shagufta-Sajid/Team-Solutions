...
class InfoController extends Controller
{
    ...
    $request->validate([
        'inputs.*.level_of_education' => 'required',
        'inputs.*.degree_title' => 'required',
        'inputs.*.group' => 'required',
        'inputs.*.institution_name' => 'required',
        'inputs.*.result' => 'required',
        'inputs.*.scale' => 'required|numeric',
        'inputs.*.cgpa' => 'required|numeric',
        'inputs.*.batch' => 'required|numeric',
        'inputs.*.passing_year' => 'required|numeric',
    ]);
